...
public class ToggleArchiveTask extends AsyncTask<Void, Void, Boolean> {

    private static String TAG = ToggleArchiveTask.class.getSimpleName();
    ...
    public ToggleArchiveTask(Context context, int articleId, DaoSession daoSession) {
    ...
    protected Boolean doInBackground(Void... params) {
        try {
            return service.toggleArchive(articleId);
        } catch (IOException e) {
